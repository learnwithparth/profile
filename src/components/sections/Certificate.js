      ...
      >
        ...
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="main-content">
            <img
              className="img-fluid"
              src="assets/certificates/16.webp"
              alt="Image Project"
            />
          </div>
        </SwiperSlide>
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="main-content">
            <img
              className="img-fluid"
              src="assets/certificates/15.webp"
              alt="Image Project"
            />
          </div>
        </SwiperSlide>
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="main-content">
            <img
              className="img-fluid"
              src="assets/certificates/14.webp"
              alt="Image Project"
            />
          </div>
        </SwiperSlide>
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="main-content">
            <img
              className="img-fluid"
              src="assets/certificates/13.png"
              alt="Image Project"
            />
          </div>
        </SwiperSlide>
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="main-content">
            <img
              className="img-fluid"
              src="assets/certificates/12.png"
              alt="Image Project"
            />
          </div>
        </SwiperSlide>
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="main-content">
            <img
              className="img-fluid"
              src="assets/certificates/11.webp"
              alt="Image Project"
            />
          </div>
        </SwiperSlide>
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="main-content">
            <img
              className="img-fluid"
              src="assets/certificates/10.png"
              alt="Image Project"
            />
          </div>
        </SwiperSlide>
